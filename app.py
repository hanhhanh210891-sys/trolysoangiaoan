...
<div class="main-header">
    ...
    <p>Tác giả: Ma Thị Hạnh - Trường TH Minh Quang - ĐT: 033 8405 503</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Ma Thị Hạnh - Trường TH Minh Quang - ĐT: 033 8405 503</div>", unsafe_allow_html=True)
